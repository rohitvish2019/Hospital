...
function setAppointmentsOnUi(appointments){
    ...
    for(let i=0;i<appointments.length;i++){
        ...
        `
            ...
            <td><a href="/patients/getOldPrescription/${appointments[i].PatientId._id}?date=${date}">${appointments[i].PatientId.Name}</a></td>
            <td><a href="/visits/oldMedBill/${appointments[i].PatientId._id}?date=${date}">${appointments[i].PatientId.Name}</a></td>
        `
