...
module.exports.getMedicalBill = async function(req, res){
    try{
        ...
        return res.render('medbill',{patient:visit.PatientId, prescriptions:visit.Prescriptions,role:req.user.role});
    }catch(err){
        console.log(err)
...
module.exports.oldMedBill = async function(req, res){
    try{
        ...
        return res.render('medbill_old', {patient:visit.PatientId, prescriptions:visit.Prescriptions,role:req.user.role});
    }catch(err){
        console.log(err);
        return res.redirect('back')
    }
